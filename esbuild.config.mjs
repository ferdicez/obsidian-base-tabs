...
const banner = `/*
Base Tabs - plugin Obsidian
Gerado por esbuild, não editar main.js diretamente.
*/`;

const prod = process.argv[2] === "production";

// Esta pasta (plugins/base-tabs) é o código-fonte de desenvolvimento. O Obsidian carrega o plugin
// de dentro de .obsidian/plugins/base-tabs (pasta real do vault) — são pastas separadas, não a mesma.
// Sem essa cópia, o build fica "pronto" mas o Obsidian continua rodando a versão antiga.
const raiz = path.dirname(fileURLToPath(import.meta.url));
const pastaVaultPlugin = path.join(raiz, "..", "..", ".obsidian", "plugins", "base-tabs");
